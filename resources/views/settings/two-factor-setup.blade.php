    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8 space-y-6">
            ...
            <div class="text-center space-y-2">
                ...
                <h1 class="text-xl font-bold text-gray-900 tracking-tight">{{ __('Enable Two-Factor Protection') }}</h1>
                <p class="text-xs text-gray-500 max-w-xs mx-auto leading-relaxed">{{ __('Scan the QR code with your authenticator application (Google Authenticator, Authy, etc.).') }}</p>
            </div>
            ...
            <div class="flex flex-col items-center justify-center p-4 bg-gray-50 rounded-xl border border-gray-100">
                ...
                <div class="mt-4 text-center w-full">
                    <span class="block text-[10px] font-semibold text-gray-400 uppercase tracking-wider">{{ __("Can't scan? Enter this code manually:") }}</span>
            ...
            <div class="space-y-3 pt-2">
                <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                    <div class="flex gap-2">
                        ...
                        <div>
                            <span class="block text-xs font-bold text-amber-800">{{ __('Save your recovery codes!') }}</span>
                            <span class="block text-[11px] text-amber-700 leading-relaxed mt-0.5">{{ __('If you lose your device, these codes are the ONLY way to access your account. Store them securely.') }}</span>
                        </div>
                    </div>
            ...
            <form action="{{ route('2fa.enable') }}" method="POST" class="space-y-4 pt-2 border-t border-gray-100">
                @csrf
                <div>
                    <label for="code" class="block text-xs font-medium text-gray-700 mb-1.5">{{ __('Enter Verification Code to Confirm') }}</label>
                    <input type="text"
                           id="code"
                           name="code"
                           required
