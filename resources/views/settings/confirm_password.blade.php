    ...
    <div class="max-w-md mx-auto my-12">
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
            <div class="text-center mb-6">
                ...
                <h1 class="text-xl font-bold text-gray-900 tracking-tight">Secure Area</h1>
                <p class="text-sm text-gray-500 mt-1">Please confirm your password to access privacy settings.</p>
            </div>
