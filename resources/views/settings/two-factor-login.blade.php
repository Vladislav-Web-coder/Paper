    ...
    <div class="max-w-md mx-auto py-6">
        <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-8 space-y-6">
            ...
            <div class="text-center space-y-2">
                ...
                <h1 class="text-xl font-bold text-gray-900 tracking-tight">Security Check Required</h1>
                <p class="text-xs text-gray-500 max-w-xs mx-auto leading-relaxed">Please enter the 6-digit authentication code from your app, or use an emergency 8-character recovery code.</p>
            </div>
            ...
            <form action="{{ route('2fa.verify') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="code" class="block text-xs font-medium text-gray-700 mb-1.5">Authentication / Recovery Code</label>
                    <input type="text"
                           id="code"
                           name="code"
                           required
