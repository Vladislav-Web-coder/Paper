<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">{{ __('Create New Note') }}</h1>
        ...
        <form action="{{ route('notes.store') }}" method="POST">
            ...
            <div class="mb-5 p-4 bg-gray-50/50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-700 rounded-xl">
                ...
                @if(!empty($folders) && count($folders) > 0)
                    <div class="mb-3">
                        ...
                        <!-- Изменено: h-auto max-h-36 автоматически подстраивает высоту под контент -->
            ...
            <div class="mb-5 p-4 bg-gray-50/50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-700 rounded-xl">
                ...
                @if(!empty($tags) && count($tags) > 0)
                    <div class="mb-3">
                        ...
                        <!-- Изменено: h-auto max-h-36 адаптируется к количеству тегов, как и блок с папками -->
                        <div class="w-full h-auto max-h-36 px-3 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-lg overflow-y-auto space-y-1.5 shadow-inner">
            ...
            <div class="flex justify-end gap-3 border-t border-gray-100 dark:border-gray-700/50 pt-6">
                <a href="{{ route('notes.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                    {{ __('Cancel') }}
                </a>
