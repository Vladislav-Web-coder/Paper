<x-app-layout>
    <x-slot name="title">{{ __('Edit Folder') }}</x-slot>
    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">{{ __('Edit Folder') }}</h1>
        ...
        <form action="{{ route('folders.update', $folder) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <x-markdown-editor name="description" :value="old('description', $folder->description)" />
